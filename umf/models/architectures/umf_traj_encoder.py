...
from umf.models.operator.cross_attention import SkipTransformerEncoder, TransformerEncoderLayer
...
class UmfTrajEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.skel_embedding = nn.Linear(147, self.latent_dim)
