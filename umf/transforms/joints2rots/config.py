import numpy as np
from umf.utils.joints import mmm_joints, smplh2mmm_indexes
...
# todo - configable
import os as _os
_SMPL_MODELS_DIR = _os.environ.get("SMPL_MODELS_DIR", "./deps/smpl_models")
SMPL_MODEL_DIR = _SMPL_MODELS_DIR + "/"
GMM_MODEL_DIR = _SMPL_MODELS_DIR + "/"
SMPL_MEAN_FILE = _os.path.join(_SMPL_MODELS_DIR, "neutral_smpl_mean_params.h5")
# for collsion
Part_Seg_DIR = _os.path.join(_SMPL_MODELS_DIR, "smplx_parts_segm.pkl")
