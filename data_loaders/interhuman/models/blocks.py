from data_loaders.interhuman.models.layers import *
...
class TransformerBlock_mdm(nn.Module):
    def __init__(self,
                 latent_dim=512,
                 num_heads=8,
                 ff_size=1024,
    ...
    def forward(self, x, y, emb=None, key_padding_mask=None): #h_a_prev, h_b_prev, emb, key_padding_mask
        h1 = self.sa_block(x, emb, key_padding_mask)
        h2 = h1 + x
        out = self.ffn(h2, emb)
        out = out + h2
