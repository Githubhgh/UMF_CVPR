...
def test_smpl(smpl_model, dtype=torch.float32):
    import time, cv2
    from renderer_pt3d import Renderer
    render = Renderer()
    cost_time = []
    batch_size = 1
    ...
    for _ in range(200):
        ...
        rendered_image = render(verts_np, faces_np)
...
def prepare_smpl_model(dtype, model_path=None):
    if model_path is None:
        model_path = os.environ.get("SMPL_MODEL_PATH", "./body_models/smpl/SMPL_NEUTRAL.pth")
